...
export class TurnStatus extends jspb.Message {
  ...
  getIsMoonDead(): boolean;
  setIsMoonDead(value: boolean): void;

  getIsSunDead(): boolean;
  setIsSunDead(value: boolean): void;

  getIsPrincessDead(): boolean;
  setIsPrincessDead(value: boolean): void;
